...
-- -----------------------------------------------------
-- Table `campus_eats_fall2020`.`Order_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `campus_eats_fall2020`.`Order_items` (
...
Insert into order_items values(1,1,1,22,'2020-10-22');
Insert into order_items values(2,2,2,22,'2021-10-22');
Insert into order_items values(101,3,3,25,'2021-10-22');

-- -----------------------------------------------------
-- Table `campus_eats_fall2020`.`menu_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `campus_eats_fall2020`.`menu_items` (
  ...
  PRIMARY KEY (`item_id`, `Order_items_order_id`, `Order_items_item_id`),
  INDEX `fk_menu_items_restaurant1_idx` (`restaurant_id` ASC) VISIBLE,
  INDEX `fk_menu_items_Order_items1_idx` (`Order_items_order_id` ASC, `Order_items_item_id` ASC) VISIBLE,
  CONSTRAINT `fk_menu_items_restaurant1`
    FOREIGN KEY (`restaurant_id`)
    REFERENCES `campus_eats_fall2020`.`restaurant` (`restaurant_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_menu_items_Order_items1`
    FOREIGN KEY (`Order_items_order_id` , `Order_items_item_id`)
    REFERENCES `campus_eats_fall2020`.`Order_items` (`order_id` , `item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
Insert into menu_items values(1,1,'Pizza','Italian',15,1,1);
Insert into menu_items values(2,2,'Dosa','Indian',20,2,2);




-- -----------------------------------------------------
-- Table `campus_eats_fall2020`.`ratings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `campus_eats_fall2020`.`ratings` (
  `ratings_id` INT NOT NULL,
  `order_id` INT NOT NULL,
  `restaurant_id` INT NOT NULL,
  `driver_id` INT NOT NULL,
  `restaurant_review` INT NOT NULL,
  `driver_review` INT NOT NULL,
  `photo_uploaded` INT NOT NULL,
  `comments` VARCHAR(450) NULL DEFAULT NULL,
  PRIMARY KEY (`ratings_id`),
  INDEX `fk_Ratings_restaurant1_idx` (`restaurant_id` ASC) VISIBLE,
  INDEX `fk_Ratings_driver1_idx` (`driver_id` ASC) VISIBLE,
  INDEX `fk_Ratings_order1_idx` (`order_id` ASC) VISIBLE,
  CONSTRAINT `fk_Ratings_order1`
    FOREIGN KEY (`order_id`)
    REFERENCES `campus_eats_fall2020`.`order` (`order_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
Insert into ratings values(1,1,1,1,4,5,6,'Nice');
Insert into ratings values(2,2,2,2,5,5,7,'Nice');
Insert into ratings values(3,3,3,3,4,2,8,'Nice');
Insert into ratings values(4,4,4,4,5,5,9,'Nice');
Insert into ratings values(5,5,5,5,3,3,10,'Nice');
Insert into ratings values(6,6,6,6,5,5,11,'Nice');
Insert into ratings values(7,7,7,7,3,5,12,'Nice');
